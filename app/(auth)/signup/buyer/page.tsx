...
export default function BuyerSignupPage() {
  ...
  return (
    <>
      <AuthLeftPanel
        heading="Start Buying on Africa's Largest Maritime Marketplace"
        description="Create your buyer account to browse verified listings, submit purchase requests, and bid in live auctions."
        benefits={[
          "Access 500+ verified maritime listings",
          "Submit purchase requests to sellers directly",
          "Bid in live auctions for premium assets",
        ]}
      />
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 py-12 bg-white overflow-y-auto">
        ...
        <div className="w-full max-w-[480px]">
          ...
          {/* Header */}
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-text-primary mb-2">Create Buyer Account</h2>
